...
class Jain_Categoryreview_Block_Adminhtml_Categoryreview_Grid extends Mage_Adminhtml_Block_Widget
{
  ...
  {
      parent::__construct();
      $this->setTemplate('categoryreview/widget/grid.phtml');
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('catid', array(
          'header'    => Mage::helper('categoryreview')->__('Category'),
          'align'     =>'left',
          'index'     => 'catid',
      ));
      ...
      $this->addColumn('detail', array(
			'header'    => Mage::helper('categoryreview')->__('Detail'),
			'index'     => 'detail',
      ));

      $this->addColumn('rating_value', array(
          'header'    => Mage::helper('categoryreview')->__('Rating'),
          'index'     => 'rating_value',
      ));
      ...
      $this->addColumn('status', array(
		...
		//$this->addExportType('*/*/exportCsv', Mage::helper('categoryreview')->__('CSV'));
		//$this->addExportType('*/*/exportXml', Mage::helper('categoryreview')->__('XML'));
    ...
    protected function _prepareMassaction()
    {
        ...
        $statuses = array(
            1 => 'Not Approved',
            2 => 'Approved',
        );//Mage::getSingleton('categoryreview/status')->getOptionArray();
